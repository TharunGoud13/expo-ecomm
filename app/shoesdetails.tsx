                ...
                <View style={styles.featureContainer}>
                    <View style={styles.featureView}>
                        ...
                        <View style={styles.sizeContainer}>
                            <TouchableOpacity
                                style={[styles.sizeView, selectedSize === '39' && styles.selectedSize]}
                                onPress={() => handleSizeSelect('39')}>
                                <Text style={[styles.sizeText, selectedSize === '39' && styles.selectedText]}>
                                    39
                                </Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={[styles.sizeView, selectedSize === '40' && styles.selectedSize]}
                                onPress={() => handleSizeSelect('40')}>
                                <Text style={[styles.sizeText, selectedSize === '40' && styles.selectedText]}>
                                    40
                                </Text>
                            </TouchableOpacity>
                            <TouchableOpacity
                                style={[styles.sizeView, selectedSize === '41' && styles.selectedSize]}
                                onPress={() => handleSizeSelect('41')}>
                                <Text style={[styles.sizeText, selectedSize === '41' && styles.selectedText]}>
                                    41
                                </Text>
                            </TouchableOpacity>
                            <TouchableOpacity
                                style={[styles.sizeView, selectedSize === '42' && styles.selectedSize]}
                                onPress={() => handleSizeSelect('42')}>
                                <Text style={[styles.sizeText, selectedSize === '42' && styles.selectedText]}>
                                    42
                                </Text>
                            </TouchableOpacity>
                        </View>
                    ...
                    <View style={styles.featureView}>
                        ...
                        <View style={styles.colorContainer}>
                            {['#607D8A', '#7A5548', '#797979'].map((color) => (
                                <TouchableOpacity
                                    key={color}
                                    style={[
                                        styles.colorView,
