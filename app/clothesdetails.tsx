                ...
                <View style={styles.featureContainer}>
                    <View style={styles.featureView}>
                        ...
                        <View style={styles.sizeContainer}>
                            <TouchableOpacity
                                style={[styles.sizeView, selectedSize === 'S' && styles.selectedSize]}
                                onPress={() => handleSizeSelect('S')}>
                                <Text style={[styles.sizeText, selectedSize === 'S' && styles.selectedText]}>
                                    S
                                </Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={[styles.sizeView, selectedSize === 'M' && styles.selectedSize]}
                                onPress={() => handleSizeSelect('M')}>
                                <Text style={[styles.sizeText, selectedSize === 'M' && styles.selectedText]}>
                                    M
                                </Text>
                            </TouchableOpacity>
                            <TouchableOpacity
                                style={[styles.sizeView, selectedSize === 'L' && styles.selectedSize]}
                                onPress={() => handleSizeSelect('L')}>
                                <Text style={[styles.sizeText, selectedSize === 'L' && styles.selectedText]}>
                                    L
                                </Text>
                            </TouchableOpacity>
                        </View>
                    ...
                    <View style={styles.featureView}>
                        ...
                        <View style={styles.colorContainer}>
                            {['#607D8A', '#7A5548', '#797979', '#9F9F9F'].map((color) => (
                                <TouchableOpacity
                                    key={color}
                                    style={[
                                        styles.colorView,
